...
import discountsImage from '@lib/public/more/discountsImage.jpg';
...
const DiscountsPage: React.FC<GetContentProps> = ({ contentData }) => {
  return (
    <>
      {/* <SEO
      ...
      /> */}
      <AboutUsComponent courseData={contentData.data} imageSrc={discountsImage} />
    </>
  );
};
